...
class PrsByMonthController extends Controller
{
    ...
    private function getInfoText(): InfoText
    {
        return new InfoText(
            ...
            paragraphs: [
                'Instead of facing an overwhelming list of hundreds or even thousands of open PRs, we group them by the month they were last updated. This makes the backlog more digestible and gives developers a clearer, more motivating way to engage with open PRs.',
